...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";function t(){var e=document.querySelectorAll(".counter-block-input")[0],o=document.querySelectorAll(".counter-block-input")[1],s=document.getElementById("select"),t=document.getElementById("total"),n=0,r=0,u=0;t.innerHTML=0,e.addEventListener("change",function(){if(n=+this.value,u=4e3*(r+n),""==o.value)t.innerHTML=0;else if(43==o.keyCode&&107==o.keyCode)event.preventDefault();else{var e=u;t.innerHTML=e*s.options[s.selectedIndex].value}}),e.addEventListener("keypress",function(e){/\d/.test(e.key)||e.preventDefault()}),o.addEventListener("change",function(){if(r=+this.value,u=4e3*(r+n),""==e.value)t.innerHTML=0;else{var o=u;t.innerHTML=o*s.options[s.selectedIndex].value}}),o.addEventListener("keypress",function(e){/\d/.test(e.key)||e.preventDefault()}),s.addEventListener("change",function(){if(""==o.value||""==e.value)t.innerHTML=0;else{var s=u;t.innerHTML=s*this.options[this.selectedIndex].value}}),document.body.addEventListener("click",function(){""!=o.value&&""!=e.value&&0!=o.value&&0!=e.value||(t.innerHTML=0)})}s.r(o),s.d(o,"default",function(){return t})},"./src/js/parts/form.js":
/*!******************************!*\
